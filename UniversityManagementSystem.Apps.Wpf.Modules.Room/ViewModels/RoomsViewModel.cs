...
{
    /// <summary>
    ///     Declares members belonging to the rooms view model.
    /// </summary>
    public class RoomsViewModel : FactChartViewModelBase<RoomFact>
    {
        ...
        public RoomsViewModel(
            ...
            IRoomFactService roomFactService
        ) : base(roomFactService)
        {
        ...
        public CampusDim CampusDim
        {
            ...
            set
            {
                ...
                Specifications[typeof(CampusDim)] = _campusDim == null
                    ? null
                    : new RoomFactCampusDimSpecification(_campusDim.Id);
